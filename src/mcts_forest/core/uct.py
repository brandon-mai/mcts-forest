...
@njit
def uct_core(n_sim, horizon, c, gamma, rollout_limit, step_fn, rollout_fn, params, n_actions, visit_count, q_hat, action_visits, child_nodes, node_states, node_counter, reward_offset, reward_scale):
...
class UCT:
    def __init__(self, env, c=1.0, horizon=100, gamma=0.99, rollout_limit=100, simulation_limit=1000, 
        ...
        try:
            ...
            raise RuntimeError(f"UCT requires procedural dynamics: {e}")
    ...
    def search(self, initial_state: int) -> Tuple[int, Dict[str, Any]]:
        ...
        uct_core(self.simulation_limit, self.horizon, self.c, self.gamma, self.rollout_limit, 
